  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {    	
      ...
      try {
        ...
        //Newly Added to hide un necessary fields- Start
        uiTable.find('tr:nth-child(1)').hide();
		uiTable.find('tr:nth-child(2)').hide();
		uiTable.find('td:nth-child(1)').hide();
		//Newly Added to hide un necessary fields - End
